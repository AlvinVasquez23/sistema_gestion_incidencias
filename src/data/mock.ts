...
/* ===== Taxonomía oficial de tipos (sin conversiones) ===== */
export const TIPOS_MAT = [
  'Faltante', 'Sobrante', 'Cruce SKU', 'Faltante de origen', 'Merma', 'Conforme', 'Con stock en IP6',
]
export const TIPOS_POR_AREA: Record<string, string[]> = {
  Decanting: ['Faltante', 'Sobrante', 'Cruce SKU', 'Faltante de origen', 'Merma'],
  Reabasto: ['Faltante', 'Sobrante', 'Cruce SKU', 'Merma', 'Conforme'],
  Apilador: ['Faltante', 'Sobrante', 'Merma', 'Con stock en IP6'],
...
export const INCIDENCIAS: Incidencia[] = [
  { id: 'INC2026-08051341', modulo: 'AMR', fecha: '05/08/2026', hora: '13:41:01', area: 'Decanting', lpn: 'CJPN00000872642', tipo: 'Faltante', reportado: 'Pizarro Quispe Mayte', estacion: 'D12', codigo: '7702425808058', descripcion: 'KOTEX PROT DIARIO INDICAD PH CJA 150UND', lote: '2630402815', cantidad: 6, um: 'Caja', observacion: 'La caja llegó 12 pero en sistema figura 24', status: 'Pendiente', sla: 'Crítico', valorizado: 1284.5 },
  { id: 'INC2026-08051340', modulo: 'AMR', fecha: '05/08/2026', hora: '13:40:22', area: 'Decanting', lpn: 'CJPN00000880466', tipo: 'Faltante de origen', reportado: 'Martinez Luyo Giannina', estacion: 'D16', codigo: '7702045955682', descripcion: 'KONZIL AC FCOX375ML COLAGENO C VIT B12', lote: 'H513367969', cantidad: 2, um: 'Caja', status: 'Pendiente', sla: 'Alerta', valorizado: 24.34 },
  { id: 'INC2026-08051339', modulo: 'AMR', fecha: '05/08/2026', hora: '13:39:57', area: 'Decanting', lpn: 'CJPN00000878029', tipo: 'Faltante', reportado: 'Garcia Catashunga Gissela', estacion: 'D22', codigo: '7750000070086', descripcion: 'PRODUCTO DEMO 7750000070086', lote: '0309826M', cantidad: 1, um: 'Caja', status: 'Cerrado', valorizado: 42.75, turno_picking: 'Turno 1', usuario_picking: 'WMS-4412', ubicacion_picking: 'D22-08', obs_revision: 'Validado contra WMS', usuario_revision: 'decanting02', fecha_revision: '05/08/2026', hora_revision: '16:20:41', causa_raiz: 'Mal Reabasto', usuario_cierre: 'decanting02', fecha_cierre: '05/08/2026', hora_cierre: '18:02:11' },
  { id: 'INC2026-08041201', modulo: 'AMR', fecha: '04/08/2026', hora: '12:01:44', area: 'Reabasto', lpn: 'CJPN00000876120', tipo: 'Cruce SKU', reportado: 'Quispe Ramos Luis', estacion: 'R12', codigo: '7750443210', descripcion: 'ACEITE VEGETAL PREMIUM 1L X12', cantidad: 4, um: 'Caja', status: 'Pendiente', sla: 'Normal', valorizado: 156.0 },
  { id: 'INC2026-08041155', modulo: 'AMR', fecha: '04/08/2026', hora: '11:55:10', area: 'Decanting', lpn: 'CJPN00000876088', tipo: 'Merma', reportado: 'Pizarro Quispe Mayte', estacion: 'D16', codigo: '7702045955682', descripcion: 'KONZIL AC FCOX375ML COLAGENO C VIT B12', cantidad: 12, um: 'Caja', status: 'Revisado', sla: 'Normal', valorizado: 320.4, turno_picking: 'Turno 1', usuario_picking: 'WMS-4412', ubicacion_picking: 'D16-04', obs_revision: 'Se validó conteo con WMS', usuario_revision: 'decanting02', fecha_revision: '04/08/2026', hora_revision: '15:12:03' },
  ...
  { id: 'INC2026-08021322', modulo: 'AMR', fecha: '02/08/2026', hora: '13:22:08', area: 'Reabasto', lpn: 'CJPN00000872014', tipo: 'Sobrante', reportado: 'Quispe Ramos Luis', estacion: 'R12', codigo: '7756719010931', descripcion: 'SMOLL PR CR TIN TBX60ML 7 4CH CHOC ME', cantidad: 8, um: 'Caja', status: 'Pendiente', sla: 'Crítico', valorizado: 2456.8 },
  { id: 'INC2026-08011512', modulo: 'AMR', fecha: '01/08/2026', hora: '15:12:50', area: 'Decanting', lpn: 'CJPN00000870122', tipo: 'Cruce SKU', reportado: 'Martinez Luyo Giannina', estacion: 'D18', codigo: '4005900998385', descripcion: 'NIV MICELAR MATE PIEL MIXT A GRASA 400ML', cantidad: 10, um: 'Caja', status: 'Revisado', sla: 'Alerta', valorizado: 890.2, usuario_revision: 'decanting02', fecha_revision: '01/08/2026', hora_revision: '17:05:12' },
  { id: 'INC2026-07311801', modulo: 'AMR', fecha: '31/07/2026', hora: '18:01:12', area: 'Decanting', lpn: 'CJPN00000868740', tipo: 'Merma', reportado: 'Pizarro Quispe Mayte', estacion: 'D16', codigo: '7750000070048', descripcion: 'PRODUCTO DEMO 7750000070048', cantidad: 3, um: 'Caja', status: 'Cerrado', valorizado: 49.8, causa_raiz: 'Mal Decanting', usuario_cierre: 'decanting02', fecha_cierre: '01/08/2026', hora_cierre: '08:15:00' },
  { id: 'INC2026-07301201', modulo: 'AMR', fecha: '30/07/2026', hora: '12:01:03', area: 'Reabasto', lpn: 'CJPN00000866215', tipo: 'Faltante', reportado: 'Quispe Ramos Luis', estacion: 'R12', codigo: '7751523000581', descripcion: 'WAWASANA CJAX20UND TE VERDE & PIA', cantidad: 5, um: 'Caja', status: 'Cerrado', valorizado: 16.0, causa_raiz: 'Mal Almacenamiento', usuario_cierre: 'reabasto02', fecha_cierre: '30/07/2026', hora_cierre: '20:10:45' },
  ...
  { id: 'AUD2026-08031115', modulo: 'AUD', fecha: '03/08/2026', hora: '11:15:44', area: 'Reabasto', lpn: 'CJPN00000874880', tipo: 'Faltante', reportado: 'Pedro Chirinos', codigo: '7756719010931', descripcion: 'SMOLL PR CR TIN TBX60ML 7 4CH CHOC ME', cantidad: 2, um: 'Caja', status: 'Pendiente', sla: 'Normal', valorizado: 614.2 },
  ...
  { id: 'API-8b6645e8', modulo: 'API', fecha: '05/08/2026', hora: '13:55:13', area: 'Apilador', cubeta: '10031569', tipo: 'Con stock en IP6', codigo: '4005900998385', descripcion: 'NIV MICELAR MATE PIEL MIXT A GRASA 400ML', cantidad: 2, status: 'Pendiente', valorizado: 21.4 },
  { id: 'API-7c21d3a9', modulo: 'API', fecha: '04/08/2026', hora: '09:12:40', area: 'Apilador', cubeta: '20045511', tipo: 'Faltante', codigo: '7750443210', descripcion: 'ACEITE VEGETAL PREMIUM 1L X12', cantidad: 5, status: 'Pendiente', valorizado: 210.0 },
  ...
  { id: 'AFR-00000003', modulo: 'AFR', fecha: '04/08/2026', hora: '16:40:02', area: 'Aframe', cubeta: 'AF-100240', tipo: 'Con stock en IP6', codigo: '7702425808058', descripcion: 'KOTEX PROT DIARIO INDICAD PH CJA 150UND', cantidad: 1, status: 'Pendiente', valorizado: 214.08 },
]
